...
public class main {
	...
	public static void main (String[] args) {
		...
		Scanner read = new Scanner (Systema.in);
		int option;
	...
	public void init () {
		...
		kangaroo hugo = new kangaroo("hugo", 95.0, 1.68, 1, 50.48, "AB",  new dated(20, 6, 2009));
		kangaroo kelly = new kangaroo("kelly", 79.0, 1.70,2, 41.0, "o", new dated( 12, 8, 2007));
		kangaroo paquita = new kangaroo ("paquita", 90.0, 1.84, 2, 74.0, "b", new dated(10, 8, 2004));
